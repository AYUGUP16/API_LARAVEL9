  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('/admin-assets/img/profile_img/user_1/Splash.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        @php
        //print_r($data);
        @endphp        
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('all_users')}}" class="nav-link {{ (Route::currentRouteName() == 'all_users') ? 'active' : ''; }}">
              <i class="nav-icon fa fa-users"></i>
              <p>Users</p>
            </a>            
          </li>

          <!-- <li class="nav-item {{ (Route::currentRouteName() == 'get_subadmins') ? 'menu-open' : ''; }}">
            <a href="" class="nav-link {{ (Route::currentRouteName() == 'get_subadmins') ? 'active' : ''; }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{'subadmins'}}" class="nav-link {{ (Route::currentRouteName() == 'get_subadmins') ? 'active' : ''; }}">
          ...
          <!-- <li class="nav-item {{ (Route::currentRouteName() == 'get_vendors') ? 'menu-open' : ''; }}">
            <a href="" class="nav-link {{ (Route::currentRouteName() == 'get_vendors') ? 'active' : ''; }}">
              <i class="nav-icon fas fa-users"></i>              
              <p>Vendors
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{'vendors'}}" class="nav-link {{ (Route::currentRouteName() == 'get_vendors') ? 'active' : ''; }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Vendors</p>
                </a>
              </li>                            
          ...
          <!-- <li class="nav-item {{ (Route::currentRouteName() == 'get_parent_categories' || Route::currentRouteName() == 'get_child_categories' || Route::currentRouteName() == 'get_subchild_categories') ? 'menu-open' : ''; }}">
            <a href="" class="nav-link {{ (Route::currentRouteName() == 'get_parent_categories' || Route::currentRouteName() == 'get_child_categories' || Route::currentRouteName() == 'get_subchild_categories') ? 'active' : ''; }}">
              <i class="nav-icon fas fa-users"></i>              
              <p>Categories
                <i class="right fas fa-angle-left"></i>
              </p>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('get_parent_categories')}}" class="nav-link {{ (Route::currentRouteName() == 'get_parent_categories') ? 'active' : ''; }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Parent Category</p>
                </a>
              </li>  
              <li class="nav-item">
                <a href="{{route('get_child_categories')}}" class="nav-link {{ (Route::currentRouteName() == 'get_child_categories') ? 'active' : ''; }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Child Category</p>
                </a>
              </li> 
              <li class="nav-item">
                 <a href="{{route('get_subchild_categories')}}" class="nav-link {{ (Route::currentRouteName() == 'get_subchild_categories') ? 'active' : ''; }}">
                  <i class="far fa-circle nav-icon"></i>
